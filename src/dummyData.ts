...
export const eventsData = [
  ...
  },
  {
    ...
    importance: 'Высокая',
    equipment: 'ИБП',
    message: 'Низкий заряд баратереи',
...
export const messageArr = ['Сервер Вегас недоступен', 'Потеряно сетевое соединение', 'Открыта крышка', 'Низкий заряд баратереи', 'Недостаточное количество масла',
